...
OUT        = os.path.join(REALIST, "grid_visualizer.html")
...
def main():
    ...
    print(f"Substations: {len(nodes)}, Plants: {len(plants)}, Split nodes: {len(split_nodes)}, Edges: {len(edges)}  (HV snap 0.45 km)")
    print("Done.")
